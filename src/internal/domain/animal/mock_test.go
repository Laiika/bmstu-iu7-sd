...
func (m *MockIAnimalRepo) GetById(arg0 context.Context, arg1 int) (*Animal, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAnimalRepo) GetCrtrAll(arg0 context.Context, arg1 int) (Animals, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAnimalRepo) Update(arg0 context.Context, arg1 int, arg2 *UpdateAnimal) (*Animal, error) {
	m.ctrl.T.Helper()
