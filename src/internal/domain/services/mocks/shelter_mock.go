...
func (m *MockIShelterRepo) Create(arg0 context.Context, arg1 *dto.CreateShelter) error {
	m.ctrl.T.Helper()
...
func (m *MockIShelterRepo) Update(arg0 context.Context, arg1 int, arg2 *dto.UpdateShelter) error {
	m.ctrl.T.Helper()
