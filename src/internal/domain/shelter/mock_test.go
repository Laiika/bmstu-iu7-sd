...
// Source: sd/internal/domain/shelter (interfaces: IShelterRepo)
...
func (m *MockIShelterRepo) Create(arg0 context.Context, arg1 *CreateShelter) (*Shelter, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0, arg1)
	ret0, _ := ret[0].(*Shelter)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIShelterRepo) GetAll(arg0 context.Context) (Shelters, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", arg0)
	ret0, _ := ret[0].(Shelters)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIShelterRepo) GetById(arg0 context.Context, arg1 int) (*Shelter, error) {
	m.ctrl.T.Helper()
...
func (m *MockIShelterRepo) Update(arg0 context.Context, arg1 int, arg2 *UpdateShelter) (*Shelter, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIShelterRepoMockRecorder) Update(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockIShelterRepo)(nil).Update), arg0, arg1, arg2)
}
